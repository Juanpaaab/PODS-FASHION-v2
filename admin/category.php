        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <a href="#addnew" data-toggle="modal" class="btn btn-primary btn-sm btn-flat" style="background-color: deeppink; border-color: white"><i class="fa fa-plus"></i> Añadir</a>
            </div>
            <div class="box-body">
